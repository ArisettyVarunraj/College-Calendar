...
<html>
<head>
	<title>Faculty Login | Amrita School of Engineering Bangalore</title>
        ...
        <?php endif ?>
                ...
                <nav>
                    <ul>
                        ...
                        <li class="current"><a href="fsin.php">Faculty Singin</a></li>
...
<form action="fsin.php" method="post">

<h2 style="color:#002966;font-size:40px;"><center>Faculty Signin<center></h2> 
...
if(isset($_POST["sbmt"])) 
{
	...
	$cn=makeconnection();			
			...
			$s="select * from faculty where Reg_no='" . $_POST["reg_no"] . "' and password='" .$_POST["psw"] . "'";
